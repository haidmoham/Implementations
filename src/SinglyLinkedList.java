...
public class SinglyLinkedList<T> {
    ...
    public void add(T element){
        ...
        if (head == null){
            ...
            head and tail point to same thing*/
            head = nd;
            tail = nd;
        }
        else {
    ...
    public void deleteAfter(T after){
        ...
        /*Traverse until given element*/
        while (true){
            if (tmp == null) break;
            if (tmp.compareTo(after) == 0){
                //found targ node, add after this node
                refNode = tmp;
                break;
            }
            tmp = tmp.getNextRef();
